...
namespace TarodevController
{
    ...
    public class PlayerController : MonoBehaviour, IPlayerController
    {
        ...
        private void Update()
        {
           ...
           // CalculateDoubleJump(); // Does Double Jump stuff
        ...
        private void CalculateWalk()
        {
            ...
            // Flips character spirte depending on horizontal movement
            if (Input.X >= 0.1)
            {
        ...
        //[SerializeField] private float _doubleJumpHeight = 10;
        ...
        //[SerializeField] private int _jumpCountMin = 0f;
        ...
        private void CalculateJump()
        {
            if (_colDown)
            {
                ...
                if (_canJump == true && (_jumpCount <= _jumpCountMax))
                {
            ...
            // Double Jump code script - Need to change
            /*if (!_colDown && Input.JumpDown && _canJump == true)
            {
                _canJump = false;
